            ...
            if (data.mostrar){
                ...
                if (data.on){
                    ...
                    if (data.luces == 'encendidas' || data.luces == 'largas'){
                        ...
                        $('.text-velocity').css({textShadow: '0px 0px 0px rgba(255, 255, 255, 0)', opacity: '.8'})
                        $('.text-car').css({textShadow: '0px 0px 0px rgba(255, 255, 255, 0)', opacity: '.8'})
                        if (!inChangeFuel){
                            $('.text-fuel').css({textShadow: '0px 0px 0px rgba(255, 255, 255, 0)', opacity: '.8'})
                        };
                        $('.rpm').css({opacity: '.8'})
                        $('.rpm2').css({boxShadow: '0px 0px 4px rgba(255, 255, 255, 0)'})
                        if (data.fuel > 19){
                            $('.fuel').css({color: 'rgb(190, 190, 190)'});
                        };
